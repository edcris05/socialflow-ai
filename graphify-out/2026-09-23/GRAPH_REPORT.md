# Graph Report - SocialFlowAI  (2026-09-23)

## Corpus Check
- 163 files · ~64,332 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 20 file(s) not represented in the graph (top: (none) 16, .example 1, .xml 1)

## Summary
- 1013 nodes · 1305 edges · 102 communities (70 shown, 32 thin omitted)
...
1. `Brand` - 66 edges
2. `KnowledgeEntry` - 32 edges
3. `User` - 27 edges
4. `TestCase` - 18 edges
5. `KnowledgeEntryController` - 13 edges
6. `ContextBuilder` - 12 edges
7. `TextKnowledgeRetriever` - 12 edges
8. `Cloud CLI` - 12 edges
...
### Community 0 - "Brand"
Cohesion: 0.06
Nodes (23): AuthController, BrandController, ContextController, Controller, DraftController, KnowledgeEntryController, Brand, Draft (+15 more)
...
### Community 3 - "User"
Cohesion: 0.07
Nodes (23): Convention and Style Best Practices, Follow Project Naming Conventions, Keep Presentation Code Maintainable, Prefer Clear, Idiomatic Syntax, Use Utilities When They Clarify Intent, Write Comments That Explain Why, User, Convention and Style Best Practices (+15 more)
...
Cohesion: 0.15
Nodes (8): Built-in Laravel Assertion Methods, How to Find Test Framework Features, File Layout, Grouping, Naming and Structure, Naming Tests, Test Class and Methods, Security Tests

### Community 9 - "Endpoint Tests"
Cohesion: 0.25
...
### Community 10 - ".setUp"
Cohesion: 0.22
Nodes (7): Data Providers, Each Test Makes Its Own Data, Factories and Test Data, Record Construction, Framework Fakes, Global Fakes, Data and Determinism

### Community 11 - "Factories and Test Data"
Cohesion: 0.40
...
### Community 56 - "Illuminate\Support\Collection"
Cohesion: 0.09
...
### Community 76 - "Routing and Controller Best Practices"
Cohesion: 0.29
...
### Community 87 - "Routing and Controller Best Practices"
Cohesion: 0.29
Nodes (6): Keep Controllers Focused on HTTP Concerns, Organize Controllers Around Resources, Routing and Controller Best Practices, Scope Nested Bindings, Use Implicit Route Model Binding, Use Resource Routes for Resourceful Actions

### Community 88 - "Reviewing Tests"
Cohesion: 0.33
Nodes (5): Assertions, Coverage, Names and Structure, Reviewing Tests, Test Value

### Community 91 - "TestCase"
Cohesion: 0.11
Nodes (8): AuthenticationTest, BrandManagementTest, ContextRetrievalTest, ExampleTest, KnowledgeManagementTest, TestCase, Illuminate\Foundation\Testing\LazilyRefreshDatabase, Illuminate\Foundation\Testing\TestCase

### Community 102 - "Testing Best Practices"
Cohesion: 0.40
Nodes (5): Consistency First, How to Apply, Rule Index, Testing Best Practices, What to Test

## Knowledge Gaps
- **517 isolated node(s):** `php`, `$schema`, `name`, `type`, `description` (+512 more)
...
- **Why does `User` connect `User` to `Brand`, `TestCase`, `UserFactory.php`?**
...
- **Should `Brand` be split into smaller, more focused modules?**
  _Cohesion score 0.06001021450459653 - nodes in this community are weakly interconnected._
